...
export class HTTPStatusError extends HTTPError {
  ...
  constructor(statusCode: number, statusText: string, request?: Request) {
    super(`HTTP ${statusCode} ${statusText}`, request);
...
export class TooManyRedirectsError extends HTTPError {
  constructor(request?: Request, message = 'Too many redirects') {
